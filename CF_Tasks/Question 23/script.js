function validateForm(){
    ...
    var email = document.getElementById("email").value;
    var nameElement = document.getElementById("addClassName");
    var flag = true;
    if(position == ""){
        document.getElementById("positionWarning").innerHTML ="Should select position"
        var flag = false
        document.getElementById("addClassPosition").classList.add("backgroundChange")
    }
    if(fullname == ""){
       document.getElementById("namewarning").innerHTML ="Should enter name"
       var flag = false
       nameElement.classList.add("backgroundChange");
    }
    else{
